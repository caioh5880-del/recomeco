...
export const PLUS_FAQS = [
  {
    ...
    answer: "Você pode assinar no plano mensal (R$ 9,90/mês) ou no plano anual com 25% de desconto (R$ 89,90/ano). A assinatura libera imediatamente todos os recursos Plus no seu perfil conectado."
  },
  {
